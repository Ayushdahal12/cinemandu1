...
const HeroSection = () => {
    ...
    bg-[url("/backgroundImage.png")] bg-cover bg-center h-screen' >
            ...
            <p className='max-w-md text-grey-300'>Lorem ipsum dolor sit amet consectetur adipisicing . laboriosam at autem perferendis in officiis enim minus maiores saepe.</p>
